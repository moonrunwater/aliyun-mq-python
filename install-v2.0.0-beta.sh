...
cp -r $cur_dir/boost/lib_python$v/libboost_python* /usr/boost/lib
...
cp $cur_dir/aliyun/v2.0.0-beta/lib/libonsclient4cpp.* /usr/aliyun/lib
cp $cur_dir/aliyun/v2.0.0-beta/lib/librocketmq_client_core.so /usr/aliyun/lib
...
echo $site_packages
cp $cur_dir/aliyun/v2.0.0-beta/lib/python$v/libaliyunmqclientpython.so $site_packages
